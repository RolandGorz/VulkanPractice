...
public class LogicalDevice {
    ...
    public LogicalDevice(PhysicalDeviceInformation physicalDeviceInformation) {
        if (physicalDeviceInformation.queueFamilyIndexes().graphicsQueueFamilyIndex().isEmpty()) {
        ...
        try (MemoryStack memoryStack = MemoryStack.stackPush()) {
            ...
            vkDeviceQueueCreateInfo
                    ...
                    .queueFamilyIndex(physicalDeviceInformation.queueFamilyIndexes().graphicsQueueFamilyIndex().get())
